<?php
 ...
 //let url = `../v1/create_user.php?name_of_share=${name_of_share}&user=${user}`;
	...
	ssh2_auth_password($connection, 'ubuntu', 'ubuntu');
 	...
 	$command = "sudo /var/www/html/src/project/home/adduser_share/shell/msaddusershare.sh {$name_of_share} {$user}";
...
<body>
  ...
  <main>
    ...
    <link><a href="adduser_share.html">click here to back</a><link>
  </main>
</body>
